...
<div class="btn-toolbar">
  <button class="btn" onclick="location='${ctx}/task/list.html'">处理中任务</button>
  <button class="btn btn-primary" onclick="location='${ctx}/task/finishList.html'">已完成任务</button>
  <div class="btn-group">
  </div>
</div>
<div class="well">
 ...
 <form action="${ctx}/task/finishList.html" id="searchForm" method="post" style="display:none;">
