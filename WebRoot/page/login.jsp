		...
		<div class="dialog">
			<div class="block">
				...
				<div class="block-body">
					<form action="${ctx}/login.html" onsubmit="return login();"  method="post"  >
						<label>帐号: </label> <input type="text" name="username"  id="username" class="span12">
						<label>密码:</label> <input type="password" name="password" id="password" class="span12">
