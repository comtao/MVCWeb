...
<div class="well">
	<div class="col-sm-8">
		<form id="form_data"  action="${ctx}/menu/addSave.html" name="form_data" method="post" class="form-horizontal">
			<table class="table table-bordered">
				...
				<tr>
					...
					<td>
					 <input class="form-control"  type="text" id="menuName"  name="name" >
					</td>
				</tr>
				<tr>
					<th>菜单描述</th>
					<td >
					 <input class="form-control" type="text" id="menuDesc" name="desc"  check="require">
					</td>
				</tr>
				<tr>
					<th>菜单路径</th>
					<td>
					  <input class="form-control" type="text" id="menuPath" name="path"  check="require">
					</td>
				</tr>
				<tr>
					<th>父级菜单*</th>
				...
				<tr>
					<th>是否可见</th>
					<td>
					  <input type="checkbox" value="1" name="visible"/>可见
					</td>
				</tr>
				<tr>
					<th>排序标识</th>
					<td>
					  <input type="text" name='orderNo' id="orderNo" value='0' style='width:250px' class="form-control">
					</td>
				</tr>
			</tbody>
			</table>
