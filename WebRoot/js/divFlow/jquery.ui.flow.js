(function($){
	$.fn.flow = function(path,option){
		var defaultOptions = {
			padding: 40,
			width : 140,       //流程线水平位置参数
			height : 2,         //流程线垂直高度（整体）
			lineWidth : 205,    //div块之间水平距离
			lineHeight : 115,    //div块竖直距离
			slider : 10,   //流程线拐点位置参数
			handle : "draw",
			img : {
				right : path+"/js/divFlow/images/right_sword.png",
				up : path+"/js/divFlow/images/right_sword.png"
			},
			hover : function(){
